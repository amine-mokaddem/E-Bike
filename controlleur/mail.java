...
public class mail {
      public static void sendmail(String recepient ,String pwd  ) throws Exception {
        ...
        String login = "yassine.bensalem@esprit.tn";
        String pass = "181JMT2772";
...
//        transport.connect();
    ...
    private static Message prepareMessage(Session session, String login, String recepient,String pwd ) {
        ...
        try {
            ...
            String htmlCode = "<!DOCTYPE html PUBLIC \"-//W3C//DTD XHTML 1.0 Transitional//EN\" \"http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd\">\n"
                    ...
                    + "                                        <b>E-bike votre mot de passe est </b>\n"
                    + "                                    </td>\n"
                    + "                                </tr>\n"
                    + "                                <tr>\n"
