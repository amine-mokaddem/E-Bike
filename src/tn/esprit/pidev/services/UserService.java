...
public class UserService {
    ...
    public ArrayList<User> parseUser(String jsonText) {
        try {
            ...
            System.out.println("USERS: "+userListJson.toString());
            User user = new User();
           user.setId((int) Float.parseFloat(userListJson.get("id").toString()));
            user.setName(userListJson.get("nom").toString());
            user.setPhone((int) Float.parseFloat(userListJson.get("numtel").toString()));
